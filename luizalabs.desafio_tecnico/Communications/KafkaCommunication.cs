...
namespace luizalabs.desafio_tecnico.Communications
{
    public class KafkaCommunication : IKafkaCommunication
    {
        private readonly ILogger<KafkaCommunication> Logger;
        private ProducerConfig Config { get; set; }

        public KafkaCommunication(ILogger<KafkaCommunication> logger, IConfiguration configuration)
        {
            Logger = logger;
